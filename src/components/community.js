                ...
                >
                    <div className="flex flex-col rounded-lg shadow-lg overflow-hidden">
                        ...
                        >
                            <div className="flex-1">
                                <a href="https://discord.gg/rocketpool" className="block mt-2"
                    ...
                    <div className="flex flex-col rounded-lg shadow-lg overflow-hidden">
                        <div className="flex-shrink-0">
                            <div className="bg-gray-800">
                                <svg
                                    className="svg-inline--fa fa-medium fa-8x h-48 w-48 mx-auto p-4 text-white block"
                                    aria-hidden="true"
                                    focusable="false"
                                    data-prefix="fab"
                                    data-icon="medium"
                    ...
                    <div className="flex flex-col rounded-lg shadow-lg overflow-hidden">
                        <div className="flex-shrink-0">
                            <div className="bg-gray-800">
                                <svg
                                    className="svg-inline--fa fa-twitter fa-8x h-48 w-48 mx-auto p-4 text-white block"
                                    aria-hidden="true"
                                    focusable="false"
                                    data-prefix="fab"
                                    data-icon="twitter"
                    ...
                    <div className="flex flex-col rounded-lg shadow-lg overflow-hidden">
                        <div className="flex-shrink-0">
                            <div className="bg-gray-800">
                                <svg
                                    className="svg-inline--fa fa-github fa-8x h-48 w-48 mx-auto p-4 text-white block"
                                    aria-hidden="true"
                                    focusable="false"
                                    data-prefix="fab"
                                    data-icon="github"
                    ...
                    <div className="flex flex-col rounded-lg shadow-lg overflow-hidden">
                        <div className="flex-shrink-0">
                            <div className="bg-gray-800">
                                <svg
                                    className="svg-inline--fa fa-discourse fa-8x h-48 w-48 mx-auto p-4 text-white block"
                                    aria-hidden="true"
                                    focusable="false"
                                    data-prefix="fab"
                                    data-icon="discourse"
                        ...
                        >
                            <div className="flex-1">
                                <a href="https://dao.rocketpool.net/" className="block mt-2"
                                ><p className="text-xl font-semibold text-gray-900">
                                        Forum
                                    </p>
                                    <p className="mt-3 text-base text-gray-500">
